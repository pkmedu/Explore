...
# Set paths
combined_csv_path = 'C:/Data/rev_final_Combined/server_dashboard.csv'
final_excel_path = 'C:/Data/rev_final_Combined/server_dashboard.xlsx'
final_html_path = 'C:/Data/rev_final_Combined/server_dashboard.html'
...
exclude_terms = ['#aiart', '#iran', 'CANADIAN', 'Havildar', 'Izak', 'MUSIC', 'Bhutan', 'Malaysia',
                ...
                'Anti - Muslim?', 'ভক্তিবেদান্ত স্বামী প্রভুপাদ', ' আটক' , ' 德媒'  ]
