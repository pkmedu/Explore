...
FILENAME MYLOG "&path\Aggregate_log.TXT";
FILENAME MYPRINT "&path\Aggregate_OUTPUT.TXT";
PROC PRINTTO LOG=MYLOG PRINT=MYPRINT NEW;
RUN;

/*****************************************************************
The Sashelp.demographics data set provides the 2004 revision of data derived 
from world population prospects. The data set contains 197 observations (countries) 
and 18 variables, including the following three (i.e., NAME, pop, and region). 

Below are the attributes of those three variables. 
NAME        TYPE      		 LABEL 
NAME      Character          GLC Country Name 
pop       Numeric            Population (2005) 
region    Character          Region 

Task: Create a table by calculating the sum and percentage of the total population 
for each region and the total population and the percentage (which will always be 100%)
for six regions combined.
*****************************************************************/
