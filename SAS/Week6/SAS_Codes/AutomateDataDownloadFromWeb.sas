...
Macro for Working with Zip Transport Files from the Web: 
The Case of the Medical Expenditure Panel Survey
Pradip K. Muhuri, Agency for Healthcare Research and Quality, Rockville, MD
- Accepted for presentation at the PharmaSUG 2022 Conference
...
****************************************************************************/
%LET Xpt_files = h163 h173;        /* XPORT engine (with PROC COPY)-created transport files */
%LET Cpt_files = ; /* PROC CPORT-created files */
