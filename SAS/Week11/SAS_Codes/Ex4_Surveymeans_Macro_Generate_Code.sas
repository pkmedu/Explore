...
OPTIONS center nodate nonumber nosymbolgen;
...
%do yr=&first %to &last;
 ...
 ods graphics off;
 ods exclude all;   
          proc surveymeans data=new.FY_%sysfunc(putn(&yr,z2.)) 
          nobs sumwgt mean stderr sum ;
          stratum varstr;
          cluster varpsu;
  ...
  %end ;
%mend runit;
filename mprint "C:\SASCourse\Week11\SAS_Codes\Ex4_Generated_Codes.sas";
