...
FILENAME MYLOG "&xpath.\_SMIF\Output\Table1_Frame_Sample_TTEST_log.TXT";
FILENAME MYPRINT "&xpath.\_SMIF\Output\Table1_Frame_Sample_TTest_output.TXT";
...
run;
proc freq data=new.Final_Both; tables racethx; run;

data new.X_Final_Both;
  set new.Final_Both;
...
ARRAY race_dummys {*} 3.  racethx_1 - racethx_5;
   DO i=1 TO 4;			      
    race_dummys(i) = 0;
  END;
  if racethx ne . then race_dummys(racethx) = 100;

  ARRAY edu_dummys {*} 3.  edu_cat_1 - edu_cat_4;
   DO i=1 TO 4;			      
    edu_dummys(i) = 0;
  END;
  if edu_cat ne . then edu_dummys(edu_cat) = 100;

ARRAY ob_dummys {*} 3.  ob_4cats_1 - ob_4cats_4;
   DO i=1 TO 4;			      
    ob_dummys(i) = 0;
  END;
  if ob_4cats ne . then ob_dummys( ob_4cats) = 100;
...
options ls=132;
proc descript data=new.X_Final_Both filetype=sas DESIGN=WR NOTSORTED;
			...
			racethx_1 racethx_2 racethx_3 racethx_4 racethx_5
			edu_cat_1 - edu_cat_2 edu_cat_3 - edu_cat_4
			ob_4cats_1 - ob_4cats_2 ob_4cats_3 - ob_4cats_4
           ;
...
proc descript data=new.X_Final_Both filetype=sas DESIGN=WR NOTSORTED;
			...
			racethx_1 racethx_2 racethx_3 racethx_5
			edu_cat_1 - edu_cat_2 edu_cat_3 - edu_cat_4
			ob_4cats_1 - ob_4cats_2 ob_4cats_3 - ob_4cats_4
