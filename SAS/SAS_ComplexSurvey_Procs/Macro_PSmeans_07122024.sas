...
proc contents data=work.d_18_21 p;
...
6    Mean          Num       8    D12.3
4    N             Num       8    BEST12.
7    StdErr        Num       8    D12.3      Std Error of Mean
5    SumWgt        Num       8    D12.3
3    VarLevel      Char     58               Variable Level
2    VarName       Char     10               Variable Name
8    filter_var    Char      5
1    year          Char      5
************************************************/
proc format;
...
proc report data=d_18_21 (where=(filter_var = &fv)); 
  ...
  define VarLevel / width=50;
  define N / display format = Comma12. width=12;
  define Sumwgt / display  format = Comma12. "Pop size" width=12;
  define mean / display format = percent7.1 "Percent" width=8;
