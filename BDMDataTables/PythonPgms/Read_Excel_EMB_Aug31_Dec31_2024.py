...
# 2️⃣ Excel file path
excel_file = r'C:\Explore\BDMDataTables\ExcelData\EMB_Aug21_Dec31_2024_cln.xlsx'

# 3️⃣ List of sheets to import (e.g., Table2 through Table72)
sheet_numbers = range(1, 32)  # 1 to 32 inclusive
...
sas_df = sas.df2sd(combined_df, table='EMB_Aug21_Dec31_2024', libref='MYDATA', temp=False)
